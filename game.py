...
def move_element(scenario_obj, game_speed, game_speed_multiplicator, x_limit, x_start, y_start):
...
if __name__ == '__main__':
    while True:
        ...
        #for i, coord in enumerate(cactus_obj.coord_list):
        #    cactus_obj.coord_list[i][0] -= 5*game_speed
        #    cactus_rect = pygame.Rect(cactus_obj.coord_list[i][0]+10, 270, 50, 40)
        #    pygame.draw.rect(screen, (0,255,0), cactus_rect)
        #    screen.blit(cactus_obj.surface, coord)
        #    if coord[0] < 100:
        #        cactus_obj.coord_list[i][0] = random.randint(800, 1500)
        #
